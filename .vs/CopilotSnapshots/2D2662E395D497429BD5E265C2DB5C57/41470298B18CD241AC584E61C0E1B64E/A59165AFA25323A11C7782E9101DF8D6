...
namespace cheat
{
    public partial class Form1 : Form
    {
        ...
        private void btn_readSpeed_Click(object sender, EventArgs e)
        {
            ...
            float speed = MemoryHelper.ReadMemoryFloat(processHandle, addr_GameSpeed);
            MessageBox.Show($"Oyun Hızı: x{speed}", "Sonuç");
        }
        ...
        private void btn_setSpeed_Click(object sender, EventArgs e)
        {
            ...
            {
                MemoryHelper.WriteMemoryFloat(processHandle, addr_GameSpeed, multiplier);
